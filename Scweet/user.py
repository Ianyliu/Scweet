...
def get_user_information(users, driver=None, headless=True):
    ...
    for i, user in enumerate(users):
        ...
        if user is not None:
            ...
            By.XPATH,'//div[contains(@data-testid,"UserProfileHeader_Items")]//a[1]')
            ...
            By.XPATH,'//div[contains(@data-testid,"UserDescription")]').text
            except Exception as e:
                # print(e)
                desc = ""
            a = 0
            try:
                join_date = driver.find_element(
            By.XPATH,
                    '//div[contains(@data-testid,"UserProfileHeader_Items")]/span[3]').text
                birthday = driver.find_element(
            By.XPATH,
